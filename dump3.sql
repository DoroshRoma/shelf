...
-- Started on 2020-01-22 11:46:27
...
--
-- TOC entry 2922 (class 0 OID 16489)
-- Dependencies: 210
...
--
-- TOC entry 2916 (class 0 OID 16401)
-- Dependencies: 204
...
--
-- TOC entry 2923 (class 0 OID 16497)
-- Dependencies: 211
...
--
-- TOC entry 2919 (class 0 OID 16445)
-- Dependencies: 207
...
--
-- TOC entry 2917 (class 0 OID 16414)
-- Dependencies: 205
...
--
-- TOC entry 2918 (class 0 OID 16427)
-- Dependencies: 206
...
100	2019-01-08 10:05:06+02	2019-01-08 10:05:06+02	Flu case	1	0
101	2019-01-08 10:05:06+02	2019-01-08 12:05:06+02	Flu case	1	0
\.


--
-- TOC entry 2921 (class 0 OID 16476)
-- Dependencies: 209
...
--
-- TOC entry 2925 (class 0 OID 16530)
-- Dependencies: 213
...
--
-- TOC entry 2926 (class 0 OID 16545)
-- Dependencies: 214
...
--
-- TOC entry 2924 (class 0 OID 16511)
-- Dependencies: 212
...
--
-- TOC entry 2920 (class 0 OID 16463)
-- Dependencies: 208
-- Data for Name: Prescriptions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."Prescriptions" (presc_id, description) FROM stdin;
0	Drink more tea! Zanamivir 3 times per day.
1	Drink more tea! Zanamivir 3 times per day.
2	Drink more tea! Zanamivir 3 times per day.
3	Drink more tea! Zanamivir 3 times per day.
4	Drink more tea! Zanamivir 3 times per day.
\.
...
-- Completed on 2020-01-22 11:46:27
